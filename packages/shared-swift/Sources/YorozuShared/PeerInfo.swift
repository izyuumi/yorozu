...
public struct PeerInfoData: Codable, Equatable, Sendable {
    ...
    public init(appVersion: String, protocolMin: Int = 1, protocolMax: Int = 1,
        capabilities: [String] = ["peer-info", "host-name", "channel-sequence", "admission-status-v1", "admission-expiry-v1"],
    ...
    public static var local: PeerInfoData {
        ...
        return PeerInfoData(appVersion: boundedText(version, maxBytes: 64) ? version : "unknown",
            capabilities: ["peer-info", "host-name", "channel-sequence", "admission-status-v1", "admission-expiry-v1"],
            requiredCapabilities: ["channel-sequence", "admission-status-v1", "admission-expiry-v1"])
    }
