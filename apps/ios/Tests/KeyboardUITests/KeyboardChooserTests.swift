...
final class KeyboardChooserTests: XCTestCase {
    ...
    func testChoosingKeepsKeyboardAndDraft() throws {
        ...
        XCTAssertTrue(app.buttons["Auto"].waitForExistence(timeout: 15))
        ...
        XCTAssertTrue(effort.waitForExistence(timeout: 15))
        effort.tap()
    ...
    func testOpeningWithoutFocusDoesNotSummonKeyboard() {
        ...
        XCTAssertTrue(chooser.waitForExistence(timeout: 30))
        chooser.tap()
        XCTAssertTrue(app.buttons["Auto"].waitForExistence(timeout: 15))
